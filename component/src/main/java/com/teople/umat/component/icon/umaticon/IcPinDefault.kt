...
public val UmatIcon.IcPinDefault: ImageVector
    get() {
        if (_icPinDefault != null) {
            return _icPinDefault!!
        }
        _icPinDefault = Builder(name = "IcPinDefault", defaultWidth = 36.0.dp, defaultHeight =
...
private var _icPinDefault: ImageVector? = null
