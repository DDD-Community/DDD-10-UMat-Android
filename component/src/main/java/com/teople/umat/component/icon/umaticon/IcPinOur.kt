...
public val UmatIcon.IcPinOur: ImageVector
    get() {
        if (_icPinOur != null) {
            return _icPinOur!!
        }
        _icPinOur = Builder(name = "IcPinOur", defaultWidth = 36.0.dp, defaultHeight = 38.0.dp,
                viewportWidth = 36.0f, viewportHeight = 38.0f).apply {
...
private var _icPinOur: ImageVector? = null
