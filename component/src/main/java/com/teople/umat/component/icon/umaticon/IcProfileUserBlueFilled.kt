...
public val UmatIcon.IcProfileUserBlueFilled: ImageVector
    get() {
        if (_IcProfileUserBlueFilled != null) {
            return _IcProfileUserBlueFilled!!
        }
        _IcProfileUserBlueFilled = Builder(
            name = "IcProfileUserBlueFilled", defaultWidth =
            24.0.dp, defaultHeight = 24.0.dp, viewportWidth = 24.0f, viewportHeight =
            24.0f
        ).apply {
            path(
                fill = SolidColor(Color(0xFF6366F1)), stroke = null, strokeLineWidth = 0.0f,
...
private var _IcProfileUserBlueFilled: ImageVector? = null
